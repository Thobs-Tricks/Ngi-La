...
//#region node_modules/@vis.gl/react-google-maps/dist/chunks/use-map-3d-BOXDWF5P.mjs
...
function usePropBinding(object, prop, value) {
	const writtenTo = (0, import_react.useRef)(null);
	(0, import_react.useEffect)(() => {
		if (!object) return;
		if (value === void 0 && writtenTo.current !== object) return;
...
*/
var hasOwn$1 = Object.hasOwn || ((object, property) => hasOwnProperty.call(object, property));
...
function isPropertyEqual(a, b, state, property) {
	...
	return hasOwn$1(b, property) && state.equals(a[property], b[property], property, property, a, b, state);
}
...
*/
var GoogleMaps3DContext$1 = import_react.createContext(null);
/**
...
* ```
*/
var Map3D$1 = (0, import_react.forwardRef)((props, ref) => {
	...
	}, map3d && import_react.createElement(GoogleMaps3DContext$1.Provider, { value: contextValue }, children)));
});
Map3D$1.displayName = "Map3D";
var Marker3DContext$1 = (0, import_react.createContext)(null);
/**
* Hook to access the Marker3D context.
*/
function useMarker3D$1() {
	return (0, import_react.useContext)(Marker3DContext$1);
}
/**
...
* ```
*/
var Marker3D$1 = (0, import_react.forwardRef)(function Marker3D(props, ref) {
	...
	return import_react.createElement(Marker3DContext$1.Provider, { value: contextValue }, isInteractive ? import_react.createElement("gmp-marker-3d-interactive", { ref: markerRef }) : import_react.createElement("gmp-marker-3d", { ref: markerRef }), (0, import_react_dom.createPortal)(children, contentContainer));
});
Marker3D$1.displayName = "Marker3D";
...
* ```
*/
var Popover$1 = (0, import_react.forwardRef)(function Popover(props, ref) {
	var _a;
...
* ```
*/
function useMap3D$1(id = null) {
	const apiContext = (0, import_react.useContext)(APIProviderContext);
	const map3dContext = (0, import_react.useContext)(GoogleMaps3DContext$1);
	if (apiContext === null) {
...
//#endregion
//#region node_modules/@vis.gl/react-google-maps/dist/chunks/static-map-LbkIhf34.mjs
/**
...
function useMapInstance(props, context) {
	...
	const reuseMapsRef = (0, import_react.useRef)(reuseMaps);
	(0, import_react.useEffect)(() => {
	...
	(0, import_react.useEffect)(() => {
		...
		let mapDiv;
		let map;
		const cachedMap = reuseMapsRef.current && CachedMapStack.has(cacheKey) ? CachedMapStack.pop(cacheKey) : null;
		...
		return () => {
			...
			mapDiv.remove();
			if (reuseMapsRef.current) CachedMapStack.push(cacheKey, map);
...
function getChangedOptions(nextOptions, trackedOptions) {
	...
	const keys = /* @__PURE__ */ new Set([...Object.keys(trackedOptions), ...Object.keys(nextOptions)]);
	for (const key of keys) {
		if (!hasOwn(nextOptions, key)) {
			changedOptions !== null && changedOptions !== void 0 || (changedOptions = Object.create(null));
			changedOptions[key] = UNSET;
			continue;
		}
		if (hasOwn(trackedOptions, key) && deepEqual(trackedOptions[key], nextOptions[key])) continue;
		changedOptions !== null && changedOptions !== void 0 || (changedOptions = Object.create(null));
...
function snapshotOptions(value) {
	if (Array.isArray(value)) return value.map((entry) => snapshotOptions(entry));
	if (value === null || typeof value !== "object") return value;
	if (Object.getPrototypeOf(value) !== Object.prototype) return value;
	const copy = {};
	for (const key of Object.keys(value)) copy[key] = snapshotOptions(value[key]);
	return copy;
}
/**
...
*/
var appliedOptionsByObject = /* @__PURE__ */ new WeakMap();
/**
...
function setMapObjectOptions(object, options, { alreadyApplied = false } = {}) {
	...
	const changedOptions = getChangedOptions(options, (_a = appliedOptionsByObject.get(object)) !== null && _a !== void 0 ? _a : {});
...
*/
var GestureHandling = GestureHandling$1;
/**
* @deprecated Import from `@vis.gl/react-google-maps/3d` instead.
*/
var GoogleMaps3DContext = GoogleMaps3DContext$1;
/**
* @deprecated Import from `@vis.gl/react-google-maps/3d` instead.
*/
var Map3D = Map3D$1;
...
* @deprecated Import from `@vis.gl/react-google-maps/3d` instead.
*/
var MapMode = MapMode$1;
/**
* @deprecated Import from `@vis.gl/react-google-maps/3d` instead.
*/
var Marker3D = Marker3D$1;
/**
* @deprecated Import from `@vis.gl/react-google-maps/3d` instead.
*/
var Marker3DContext = Marker3DContext$1;
/**
* @deprecated Import from `@vis.gl/react-google-maps/3d` instead.
*/
var useMarker3D = useMarker3D$1;
/**
* @deprecated Import from `@vis.gl/react-google-maps/3d` instead.
*/
...
var MapControl = ({ children, position, className, style }) => {
...
var PinLegacy = (props) => {
	...
	const marker3dContext = (0, import_react.useContext)(Marker3DContext$1);
