(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ReactGoogleMaps = {}, global.React, global.ReactDOM));
    ...
    function usePropBinding(object, prop, value) {
        const writtenTo = React.useRef(null);
        React.useEffect(() => {
            if (!object)
                return;
            if (value === undefined && writtenTo.current !== object)
                return;
    ...
    function useCustomElementRef(ref) {
        ...
        React.useImperativeHandle(ref, () => element, [element]);
     ...
     */
    const CirclePath = React.forwardRef(function CirclePath(props, ref) {
        ...
        return (React.createElement("gmp-circle-path", { ref: circlePathRef, center: center, radius: radius }));
    });
     ...
     */
    const Flattener = React.forwardRef(function Flattener(props, ref) {
        ...
        return (React.createElement("gmp-flattener", { ref: flattenerRef, innerPaths: innerPaths, path: path }));
    });
     ...
     */
    const SafeReact = Object.assign({}, React__namespace);
     ...
     */
    const Marker = React.forwardRef(function Marker(props, ref) {
        ...
        return isInteractive ? (React.createElement("gmp-marker-interactive", { ref: markerRef }, children)) : (React.createElement("gmp-marker", { ref: markerRef }, children));
    });
     ...
     */
    const Model3D = React.forwardRef(function Model3D(props, ref) {
        ...
        return isInteractive ? (React.createElement("gmp-model-3d-interactive", { ref: modelRef })) : (React.createElement("gmp-model-3d", { ref: modelRef }));
    });
     ...
     */
    const Polygon3D = React.forwardRef(function Polygon3D(props, ref) {
        ...
        return isInteractive ? (React.createElement("gmp-polygon-3d-interactive", { ref: polygonRef })) : (React.createElement("gmp-polygon-3d", { ref: polygonRef }));
    });
     ...
     */
    const Polyline3D = React.forwardRef(function Polyline3D(props, ref) {
        ...
        return isInteractive ? (React.createElement("gmp-polyline-3d-interactive", { ref: polylineRef })) : (React.createElement("gmp-polyline-3d", { ref: polylineRef }));
    });
