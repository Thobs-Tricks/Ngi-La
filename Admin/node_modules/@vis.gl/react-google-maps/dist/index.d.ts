...
import React__default, { DetailedHTMLProps, HTMLAttributes, CSSProperties, PropsWithChildren, FunctionComponent, Ref, ReactNode } from 'react';
...
declare const AdvancedMarkerContext: React__default.Context<AdvancedMarkerContextValue | null>;
/**
...
declare const AdvancedMarker: React__default.ForwardRefExoticComponent<Omit<google.maps.marker.AdvancedMarkerElementOptions, "gmpDraggable" | "gmpClickable" | "content" | "map" | "collisionBehavior"> & AdvancedMarkerEventProps & {
    draggable?: boolean;
    clickable?: boolean;
    collisionBehavior?: CollisionBehavior;
    /**
...
} & React__default.RefAttributes<google.maps.marker.AdvancedMarkerElement>>;
...
declare const APIProviderContext: React__default.Context<APIProviderContextValue | null>;
...
declare const Circle: React__default.ForwardRefExoticComponent<Omit<google.maps.CircleOptions, "map" | "center" | "radius"> & CircleEventProps & {
    /** Controlled center position */
    center?: google.maps.LatLngLiteral | google.maps.LatLng;
    /** Uncontrolled initial center position */
    defaultCenter?: google.maps.LatLngLiteral | google.maps.LatLng;
    ...
    /** Uncontrolled initial radius in meters */
    defaultRadius?: number;
} & React__default.RefAttributes<google.maps.Circle>>;
...
declare const GoogleMapsContext: React__default.Context<GoogleMapsContextValue | null>;
...
declare const Polygon: React__default.ForwardRefExoticComponent<Omit<google.maps.PolygonOptions, "map" | "paths"> & PolygonEventProps & {
    /**
     * An existing Polygon instance to use instead of creating a new one.
     * Other props will still be applied to this instance.
     */
    ...
    /** Uncontrolled initial paths */
    defaultPaths?: PathsType;
} & React__default.RefAttributes<google.maps.Polygon>>;
...
declare const Polyline: React__default.ForwardRefExoticComponent<Omit<google.maps.PolylineOptions, "map" | "path"> & PolylineEventProps & {
    /**
     * An existing Polyline instance to use instead of creating a new one.
     * Other props will still be applied to this instance.
     */
    ...
    /** Uncontrolled initial path */
    defaultPath?: PathType;
} & React__default.RefAttributes<google.maps.Polyline>>;

/**
 * Base event type for all Map3D events.
 */
interface Map3DEvent$1 {
    type: string;
 ...
 */
interface Map3DCameraChangedEvent$1 extends Map3DEvent$1 {
    detail: {
 ...
 */
interface Map3DClickEvent$1 extends Map3DEvent$1 {
    detail: {
 ...
 */
interface Map3DSteadyChangeEvent$1 extends Map3DEvent$1 {
    detail: {
        isSteady: boolean;
    };
}
 ...
 */
interface Map3DEventProps$1 {
    /** Called when the center property changes. */
    onCenterChanged?: (event: Map3DCameraChangedEvent$1) => void;
    /** Called when the heading property changes. */
    onHeadingChanged?: (event: Map3DCameraChangedEvent$1) => void;
    /** Called when the tilt property changes. */
    onTiltChanged?: (event: Map3DCameraChangedEvent$1) => void;
    /** Called when the range property changes. */
    onRangeChanged?: (event: Map3DCameraChangedEvent$1) => void;
    /** Called when the roll property changes. */
    onRollChanged?: (event: Map3DCameraChangedEvent$1) => void;
    /** Called when any camera property changes (aggregated). */
    onCameraChanged?: (event: Map3DCameraChangedEvent$1) => void;
    /** Called when the map is clicked. */
    onClick?: (event: Map3DClickEvent$1) => void;
    /** Called when the map's steady state changes. */
    onSteadyChange?: (event: Map3DSteadyChangeEvent$1) => void;
    /** Called when a fly animation ends. */
    onAnimationEnd?: (event: Map3DEvent$1) => void;
    /** Called when a map error occurs. */
    onError?: (event: Map3DEvent$1) => void;
}
...
type MapMode$1 = (typeof MapMode$1)[keyof typeof MapMode$1];
/**
 ...
 */
declare const GestureHandling$1: {
    /**
 ...
 */
type Map3DProps$1 = PropsWithChildren<Omit<google.maps.maps3d.Map3DElementOptions, 'center' | 'mode' | 'gestureHandling'> & Map3DEventProps$1 & {
    /**
     * An id for the map, this is required when multiple maps are present
     * in the same APIProvider context.
     */
     ...
     */
    gestureHandling?: GestureHandling$1;
 ...
 */
interface Marker3DContextValue$1 {
 ...
 */
declare function useMarker3D$1(): Marker3DContextValue$1 | null;
/**
 ...
 */
type Marker3DProps$1 = PropsWithChildren<Omit<google.maps.maps3d.Marker3DElementOptions, 'collisionBehavior' | 'altitudeMode'> & Marker3DEventProps & {
    /**
 ...
 */
type PopoverProps$1 = PropsWithChildren<Omit<google.maps.maps3d.PopoverElementOptions, 'altitudeMode' | 'positionAnchor'> & PopoverEventProps & {
    /**
     * Specifies how the altitude component of the position is interpreted.
     * @default AltitudeMode.CLAMP_TO_GROUND
     */
 ...
 * ```
 */
declare function useMap3D$1(id?: string | null): google.maps.maps3d.Map3DElement | null;
 ...
 * @deprecated Import from `@vis.gl/react-google-maps/3d` instead.
 */
type GestureHandling = GestureHandling$1;
/**
 * @deprecated Import from `@vis.gl/react-google-maps/3d` instead.
 */
declare const GoogleMaps3DContext: React.Context<GoogleMaps3DContextValue$1 | null>;
/**
 * @deprecated Import from `@vis.gl/react-google-maps/3d` instead.
 */
type GoogleMaps3DContextValue = GoogleMaps3DContextValue$1;
/**
 * @deprecated Import from `@vis.gl/react-google-maps/3d` instead.
 */
declare const Map3D: React.ForwardRefExoticComponent<Omit<google.maps.maps3d.Map3DElementOptions, "center" | "gestureHandling" | "mode"> & Map3DEventProps$1 & {
    id?: string;
...
} & React.RefAttributes<Map3DRef$1>>;
/**
 * @deprecated Import from `@vis.gl/react-google-maps/3d` instead.
 */
type Map3DProps = Map3DProps$1;
/**
 * @deprecated Import from `@vis.gl/react-google-maps/3d` instead.
 */
type Map3DRef = Map3DRef$1;
/**
 * @deprecated Import from `@vis.gl/react-google-maps/3d` instead.
 */
 ...
 * @deprecated Import from `@vis.gl/react-google-maps/3d` instead.
 */
type MapMode = MapMode$1;
/**
 * @deprecated Import from `@vis.gl/react-google-maps/3d` instead.
 */
type Map3DCameraChangedEvent = Map3DCameraChangedEvent$1;
/**
 * @deprecated Import from `@vis.gl/react-google-maps/3d` instead.
 */
type Map3DClickEvent = Map3DClickEvent$1;
/**
 * @deprecated Import from `@vis.gl/react-google-maps/3d` instead.
 */
type Map3DEvent = Map3DEvent$1;
/**
 * @deprecated Import from `@vis.gl/react-google-maps/3d` instead.
 */
type Map3DEventProps = Map3DEventProps$1;
/**
 * @deprecated Import from `@vis.gl/react-google-maps/3d` instead.
 */
type Map3DSteadyChangeEvent = Map3DSteadyChangeEvent$1;
/**
 * @deprecated Import from `@vis.gl/react-google-maps/3d` instead.
 */
declare const Marker3D: React.ForwardRefExoticComponent<Omit<google.maps.maps3d.Marker3DElementOptions, "collisionBehavior" | "altitudeMode"> & {
    onClick?: (e: Event) => void;
} & {
    altitudeMode?: AltitudeMode;
    collisionBehavior?: CollisionBehavior;
 ...
 * @deprecated Import from `@vis.gl/react-google-maps/3d` instead.
 */
declare const Marker3DContext: React.Context<Marker3DContextValue$1 | null>;
/**
 * @deprecated Import from `@vis.gl/react-google-maps/3d` instead.
 */
declare const useMarker3D: typeof useMarker3D$1;
/**
 * @deprecated Import from `@vis.gl/react-google-maps/3d` instead.
 */
type Marker3DContextValue = Marker3DContextValue$1;
/**
 * @deprecated Import from `@vis.gl/react-google-maps/3d` instead.
 */
type Marker3DProps = Marker3DProps$1;
/**
 * @deprecated Import from `@vis.gl/react-google-maps/3d` instead.
 */
declare const Popover: React.ForwardRefExoticComponent<Omit<google.maps.maps3d.PopoverElementOptions, "altitudeMode" | "positionAnchor"> & {
    onClose?: () => void;
 ...
 * @deprecated Import from `@vis.gl/react-google-maps/3d` instead.
 */
declare const useMap3D: typeof useMap3D$1;
...
declare const StaticMap: (props: StaticMapProps) => React__default.JSX.Element;
 ...
 */
declare const Marker: React__default.ForwardRefExoticComponent<Omit<google.maps.MarkerOptions, "map"> & MarkerEventProps & React__default.RefAttributes<google.maps.Marker>>;
...
declare const Rectangle: React__default.ForwardRefExoticComponent<Omit<google.maps.RectangleOptions, "map" | "bounds"> & RectangleEventProps & {
    /** Controlled bounds */
    bounds?: google.maps.LatLngBoundsLiteral | google.maps.LatLngBounds;
    /** Uncontrolled initial bounds */
    defaultBounds?: google.maps.LatLngBoundsLiteral | google.maps.LatLngBounds;
} & React__default.RefAttributes<google.maps.Rectangle>>;
...
declare function useMapsLibrary<K extends LibraryName>(name: K): google.maps.ImportLibraryMap[K] | null;
...
export type { APIProviderContextValue, APIProviderProps, AdvancedMarkerContextValue, AdvancedMarkerProps, AdvancedMarkerRef, CircleProps, CircleRef, CustomMarkerContent, GoogleMaps3DContextValue, GoogleMapsContextValue, InfoWindowProps, Map3DCameraChangedEvent, Map3DClickEvent, Map3DEvent, Map3DEventProps, Map3DProps, Map3DRef, Map3DSteadyChangeEvent, MapCameraChangedEvent, MapCameraProps, MapEvent, MapEventProps, MapMouseEvent, MapProps, Marker3DContextValue, Marker3DProps, MarkerProps, MarkerRef, PinProps, PolygonProps, PolygonRef, PolylineProps, PolylineRef, PopoverProps, ReactIntrinsicElementBridge, ReactIntrinsicElementBridgeMap, RectangleProps, RectangleRef, StaticMapProps, StaticMapsApiOptions, StaticMapsLocation, StaticMapsMarker, StaticMapsPath };
