(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function useMapInstance(props, context) {
        ...
        const reuseMapsRef = React.useRef(reuseMaps);
        React.useEffect(() => {
     ...
     */
    const GoogleMaps3DContext$1 = React.createContext(null);
    /**
     ...
     * ```
     */
    const Map3D$1 = React.forwardRef((props, ref) => {
        const { children, id, className, style } = props;
        ...
        return (React.createElement("div", Object.assign({ ref: containerRef, "data-testid": "map-3d", style: className ? undefined : combinedStyle, className: className }, (id ? { id } : {})),
            React.createElement("gmp-map-3d", { ref: map3dRef, style: { width: '100%', height: '100%' } }, map3d && (React.createElement(GoogleMaps3DContext$1.Provider, { value: contextValue }, children)))));
    });
    Map3D$1.displayName = 'Map3D';

    const Marker3DContext$1 = React.createContext(null);
    /**
     * Hook to access the Marker3D context.
     */
    function useMarker3D$1() {
        return React.useContext(Marker3DContext$1);
    }
    /**
     ...
     * ```
     */
    const Marker3D$1 = React.forwardRef(function Marker3D(props, ref) {
        ...
        usePropBinding(marker, 'zIndex', zIndex);
        usePropBinding(marker, 'title', title !== null && title !== void 0 ? title : '');
        return (React.createElement(Marker3DContext$1.Provider, { value: contextValue },
     ...
     * ```
     */
    const Popover$1 = React.forwardRef(function Popover(props, ref) {
        var _a;
    ...
    function useMap3D$1(id = null) {
        ...
        const map3dContext = React.useContext(GoogleMaps3DContext$1);
        if (apiContext === null) {
    ...
    const PinLegacy = props => {
        ...
        const marker3dContext = React.useContext(Marker3DContext$1);
