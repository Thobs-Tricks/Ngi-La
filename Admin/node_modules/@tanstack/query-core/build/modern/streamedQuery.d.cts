import { Ct as QueryKey, St as QueryFunctionContext, xt as QueryFunction } from "./hydration-Br9VIGXa.cjs";
 ...
 * ```
 */
export declare function streamedQuery<TQueryFnData = unknown, TData = Array<TQueryFnData>, TQueryKey extends QueryKey = QueryKey>({ streamFn, refetchMode, reducer, initialValue }: StreamedQueryParams<TQueryFnData, TData, TQueryKey>): QueryFunction<TData, TQueryKey>;
//#endregion
