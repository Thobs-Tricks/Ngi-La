...
export default function DirectionsSheet({
    ...
    const openInMapsApp = () => {
        ...
        // No pin yet - fall back to a name+area text search instead of coordinates.
        const query = encodeURIComponent(`${vendor.name} ${vendor.location}`);
                ...
                >
                    ...
                    {hasVendorCoords ? (
                        ...
                        >
                            ...
                            >
                                {vendor.name} hasn't pinned an exact location yet.{"\n"}
                                We'll search by name and area instead.
                            </Text>
                        </View>
                    )}
